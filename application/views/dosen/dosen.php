...
<div class="card border-0 shadow-sm rounded-4">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center border-bottom">
        <h5 class="card-title m-0 fw-bold" style="color: #012970; font-size: 1.1rem;">Data Dosen Pengampu</h5>
        
        <a href="<?=site_url('dosen/tambah/')?>" class="btn btn-primary btn-sm rounded-pill px-3 shadow-sm">
        ...
        <div class="table-responsive">
            ...
            <?php else: ?>
                <div class="text-center py-5">
                    ...
                    <p class="mt-2 text-muted fw-medium">Tidak ada data dosen untuk ditampilkan.</p>
                </div>
            <?php endif ?>
        </div>
